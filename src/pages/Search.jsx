...
const Search = () => {
  ...
  //     const startTime = hourlySchedules[startTimeIndex]?.startTime || "";
  //     const endTime = hourlySchedules[endTimeIndex]?.endTime || "";
  //     const headCount = count;
  //     const sort = " GRADE_DESC";
